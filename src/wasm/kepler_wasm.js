/* @ts-self-types="./kepler_wasm.d.ts" */
...
export class Cluster {
     ...
     */
    kill_leader() {
        const ret = wasm.cluster_kill_leader(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    revive(id) {
        wasm.cluster_revive(this.__wbg_ptr, id);
    }
    /**
    ...
    snapshot() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.cluster_snapshot(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    tick() {
        wasm.cluster_tick(this.__wbg_ptr);
    }
    /**
    ...
    write(key) {
        ...
        const ret = wasm.cluster_write(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('kepler_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
